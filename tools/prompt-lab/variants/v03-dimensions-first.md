...
For example: if the building is 69 feet wide from x=0.10 to x=0.90 (so 1 foot ≈ 0.0116 normalized units) and a bedroom starts 12 feet from the left wall and is 14 feet wide, its left edge is at x = 0.10 + 12 × 0.0116 = 0.24 and its right edge is at x = 0.10 + 26 × 0.0116 = 0.40.
...

{
  ...
  "building_scale": {"width_ft": 69, "height_ft": 30, "left_norm": 0.10, "top_norm": 0.15, "right_norm": 0.90, "bottom_norm": 0.85},
  "rooms": [
    {
